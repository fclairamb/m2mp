 ...
 *         <p/>
 *         (We don't declare it AutoCloseable as closing makes no sense in the
 *         DbFileInputStream [contrary to the DbFileOutputStream where it means flushing])
 */
public class DbFileInputStream extends InputStream {
    ...
    public int read() throws IOException {
        ...
        // If we're on the beginning or the end of the block, we must getData the next block
